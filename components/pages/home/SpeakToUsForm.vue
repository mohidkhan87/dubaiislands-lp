<template>
  <div class="px-5 py-5 flex flex-col gap-5">
    ...
    <div>
      <ClientOnly>
        <vue-tel-input
          ...
          required
          :class="[
            'vti-parent py-3 border !border-[#EFEFEF] !rounded-md !bg-[#F7F7F7] !outline-none focus-within:!shadow-none',
    ...
    <button
      ...
      @click="onSubmit"
      type="submit"
      :class="`text-white p-4 shadow rounded-lg bg-[#005BC9] w-full cursor-pointer`"
    >
